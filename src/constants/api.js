...
// Constantes privées au module (non exportées pour ne pas polluer l'espace global)
...
/**
 * ApiController - Service centralisé pour les données NHL
 */
export const ApiController = {
  ...
  getGameShots: async () => {
    try {
      ...
      return ApiController._transformData(json.plays);
